...
> **INSTRUCTIONS FOR COPILOT**: This document provides architectural context for the ScottyGo project. **Do not recite this information unless specifically asked**. When the user has a specific question or task (e.g., debugging an error, implementing a feature, reviewing code), **answer their question directly** using this context as background reference only. Only provide a project overview if the user explicitly asks "what is this project?" or similar general questions.
