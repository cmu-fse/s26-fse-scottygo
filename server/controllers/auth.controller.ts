...
export default class AuthController extends Controller {
  ...
  public initializeRoutes(): void {
    ...
    // I've followed prof's below instruction and added the "?" to make username optional and
    // handle missing username inside login method in controller, like missing password
    /*Prof's instructions in LoginToYACA US: 
          Missing username can be handled in two ways:
            On the client: ...
            On the server: Change the REST endpoint to make the username path parameter optional 
            (specify the path parameter with a '?' at the end, like this: 
              "POST /auth/tokens/:username? { password: string }"
    */
